...
import { Activity, QrCode, Map, Bell, ChevronRight, Train, Users, Shield } from 'lucide-react';

const LandingPage = () => {
    return (
        <div className="min-h-screen font-sans flex flex-col">
            {/* Navbar */}
            <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b-4 border-b-transparent" style={{ borderImage: 'linear-gradient(to right, #FF9933, #FFFFFF, #138808) 1' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <div className="flex items-center space-x-3">
                            <div className="relative w-10 h-10 flex items-center justify-center">
                                <div className="absolute inset-0 rounded-full border-2 border-brand-navy animate-spin-slow" style={{ animationDuration: '10s' }}></div>
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            <Link to="/map" className="font-bold text-gray-700 hover:text-brand-saffron transition-colors">Live Map</Link>
                            <Link to="/ticketing" className="font-bold text-gray-700 hover:text-brand-navy transition-colors">Ticketing</Link>
                            <Link to="/login" className="px-6 py-2.5 rounded-full bg-gradient-to-r from-brand-saffron via-brand-white to-brand-green text-brand-navy font-bold shadow-lg hover:shadow-xl hover:scale-105 transition-all relative overflow-hidden group">
                                ...
                                <span className="relative text-shadow-sm flex items-center">
                                    Login <img src="https://upload.wikimedia.org/wikipedia/en/4/41/Flag_of_India.svg" className="w-6 h-4 ml-2 border border-white/20 shadow-sm" alt="India" />
                                </span>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <h1 className="text-6xl md:text-7xl font-extrabold text-gray-900 leading-tight mb-8">
                                <span className="text-brand-saffron">Desh Ki</span><br />
                                <span className="text-brand-navy">Raftaar.</span><br />
                                <span className="text-brand-green">Mumbai Ki Shaan.</span>
                            </h1>
                            <p className="text-xl text-gray-600 mb-10 leading-relaxed font-medium">
                                Celebrating the spirit of the Republic with a smarter, safer, and faster commute for every Mumbaikar.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-5">
                                <Link to="/live-status" className="group flex items-center justify-center px-8 py-4 rounded-xl bg-brand-navy text-white font-bold text-lg shadow-lg hover:bg-brand-saffron transition-all duration-300">
                                    Check Live Status
                                    <ChevronRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                                </Link>
                                <Link to="/digital-ticket" className="flex items-center justify-center px-8 py-4 rounded-xl border-2 border-brand-navy text-brand-navy font-bold text-lg hover:bg-brand-navy hover:text-white transition-all">
                        ...
                        <div className="relative hidden lg:block">
                            ...
                            <img
                                src="/assets/train-hero.jpg"
                                alt="Mumbai Local"
                                className="relative rounded-3xl shadow-2xl border-4 border-white rotate-2 hover:rotate-0 transition-all duration-500 scale-105 object-cover h-[500px] w-full"
                            />
                            ...
                            <div className="absolute -bottom-10 -left-10 bg-white p-6 rounded-2xl shadow-xl border-l-4 border-brand-saffron flex items-center space-x-4 animate-bounce-slow">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 font-bold uppercase">Daily Passengers</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-24 relative z-10">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-16">
                        <h3 className="text-brand-navy font-bold tracking-wider uppercase text-sm mb-2">Our Smart Features</h3>
                        <h2 className="text-4xl font-extrabold text-gray-900">Modernizing Your Daily Commute</h2>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden relative border border-white/20 bg-brand-navy/90 backdrop-blur-md">
                        <div className="relative z-10 md:w-1/2">
                            <h2 className="text-3xl font-bold text-white mb-4">Interactive Live Map</h2>
                            <p className="text-blue-100 mb-8">Track every train on the Western, Central, and Harbour lines in real-time. Visualize delays and find your train instantly.</p>
            ...
            <footer className="relative z-10 py-12 backdrop-blur-md bg-white/30 border-t border-white/20">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <div className="flex justify-center items-center space-x-2 mb-4">
                        <Train className="w-6 h-6 text-brand-navy" />
                        <span className="text-2xl font-bold text-brand-navy">SMART RAIL MUMBAI</span>
                    </div>
                    <p className="text-gray-500 text-sm">© 2026 Ministry of Railways & MMRDA. Digital India Initiative.</p>
                </div>
            </footer>
        </div >
    );
...
const FeatureCard = ({ icon, title, desc, link }) => (
    <div className="p-8 rounded-2xl bg-white/60 backdrop-blur-xl border border-white/50 shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-300 group">
        ...
        <a href="#" className="text-brand-navy font-bold text-sm flex items-center group-hover:underline">
