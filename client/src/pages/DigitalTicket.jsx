...
import { useLocation, Link } from 'react-router-dom'; // Using Link to navigate
import { QrCode, Download, Share2, CheckCircle2, ShieldCheck, Home } from 'lucide-react'; // Added Home icon
                    ...
                    <div className="bg-white rounded-3xl shadow-2xl overflow-hidden relative z-10">
                        ...
                        <div className="bg-brand-navy p-6 pt-8 text-white text-center relative overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mb-3 shadow-lg">
                                    <img src="https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Flag_of_India.svg/1200px-Flag_of_India.svg.png" className="w-10 h-10 object-cover rounded-full mix-blend-multiply" alt="Emblem" />
                                </div>
                                <h2 className="text-xl font-bold tracking-widest uppercase">M-Ticket</h2>
                                <p className="text-blue-200 text-xs font-medium mt-1">UTS Mobile Ticketing</p>
                            </div>
                        </div>
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    <p className="text-xs text-gray-400 uppercase font-bold">Source</p>
                                    <p className="text-xl font-black text-gray-800 uppercase">{ticketData.source}</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-xs text-gray-400 uppercase font-bold">Destination</p>
                                    <p className="text-xl font-black text-gray-800 uppercase">{ticketData.destination}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-6">
                                <div className="p-3 bg-gray-50 rounded-xl">
                                    ...
                                    <p className="font-bold text-brand-navy">{ticketData.class}</p>
                                </div>
                                <div className="p-3 bg-gray-50 rounded-xl">
                                    <p className="text-xs text-gray-400 uppercase font-bold">Type</p>
                                    <p className="font-bold text-brand-navy">{ticketData.ticketType}</p>
                                </div>
                                <div className="p-3 bg-gray-50 rounded-xl">
                                    <p className="text-xs text-gray-400 uppercase font-bold">Adults</p>
                                    <p className="font-bold text-brand-navy">{ticketData.passengers}</p>
                                </div>
                                <div className="p-3 bg-brand-saffron/10 rounded-xl">
                                    <p className="text-xs text-brand-saffron uppercase font-bold">Fare</p>
                                    <p className="font-bold text-brand-saffron">₹{ticketData.fare || 15}</p>
                                </div>
                            </div>

                            {/* QR Code */}
                            <div className="flex flex-col items-center justify-center p-4 border-2 border-dashed border-brand-navy/20 rounded-2xl bg-brand-navy/5 mb-6">
                                <QrCode className="w-32 h-32 text-brand-navy mb-2" />
                                <p className="text-[10px] text-gray-500 font-mono tracking-widest">UTS-2940-5920-1039</p>
                            </div>
                        ...
                        <div className="bg-gray-50 p-4 grid grid-cols-2 gap-3">
                            ...
                            {/* Home Button */}
                            <Link to="/" className="col-span-2 flex items-center justify-center p-3 rounded-xl bg-brand-saffron text-white shadow-lg text-sm font-bold hover:bg-brand-saffron/90">
